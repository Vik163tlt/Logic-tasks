public class Main {
    public static void main(String[] args) {
        ...
        System.out.println("\nЗадание 7");
        StringBuilder string1 = new StringBuilder("135");
        StringBuilder string2 = new StringBuilder("246");
        StringBuilder string3 = string1.append(string2);
        ...
        System.out.println("\nЗадание 8");
        String string4 = "aabccddefgghiijjkk";
        int n = 1;
        for (n = 1; n < string4.length();  n++) {
            char m = string4.charAt(n);
            if (m == string4.charAt(n - 1)) {
                System.out.print(m);
            }
        }
